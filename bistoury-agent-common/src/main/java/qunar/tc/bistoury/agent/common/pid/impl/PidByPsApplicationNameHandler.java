 ...
 * @describe：
 */
public class PidByPsApplicationNameHandler extends AbstractPidHandler implements PidHandler {

    private static final Logger logger = LoggerFactory.getLogger(PidByPsApplicationNameHandler.class);
    ...
    @Override
    public int priority() {
        return Priority.FROM_PS_APPLICATION_PRIORITY;
    }
    ...
    private static String getPsInfo() {
        ...
        logger.info("---> 执行ps命令查询进程：{}", command);
